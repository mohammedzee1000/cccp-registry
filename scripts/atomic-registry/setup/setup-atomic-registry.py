...
class AtomicRegistryQuickstartSetup:
    ...
    def _create_scripts(self):
        ...
        os.chmod(ocmscript, stat.S_IRWXU | stat.S_IRGRP | stat.S_IXGRP | stat.S_IROTH | stat.S_IXOTH)
    ...
    def test_customize(self):
        ...
        # Create some scripts to ease users pain of managing the origin container.
        self._create_scripts()
...
def check_prerequisites():
    ...
    print " - Some auth providers make use of urls, and it is assumed that these urls are valid. Some validations are done"
    print "   to ensure that what you are providing is a url but it wont tell if it it works the way it is supposed to."
    print "\033[0m"
